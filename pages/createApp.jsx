            ...
            <div className="form_step_content">
                ...
                <div className="containerr">
                    <ul className="ks-cboxtags">
                      ...
                      <li><input type="checkbox" id="iOSApp" value="ioss"  onChange={platformChoose} disabled/><label htmlFor="iOSApp">iOS (alpha)</label></li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="form_step_content">
                ...
                <div className="form_step_content_input android_inputs">
                    ...
                    <div>
                        ...
                        <label className="rad-label" style={{'display': 'none'}}>
                          <input type="radio" className="rad-input" onChange={haveKeystore} name="keystoreRadio" disabled/>
                          <div className="rad-design"></div>
                          <div className="rad-text">I have a keystore (For Android) (currently not available)</div>
                        </label>
